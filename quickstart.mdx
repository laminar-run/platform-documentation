...
<Steps>
  <Step title="Connect a desktop">
    Jobs run on a Windows machine with the [Minicor Desktop Service](/running/desktop-service) installed. You can use a cloud desktop provisioned through Minicor or a machine in your own environment. Once the desktop is connected, it appears in your workspace with a live preview.
