...
Each desktop runs the [Minicor Desktop Service](/running/desktop-service), the service that connects the machine to the platform, executes automation steps, and captures replays. Minicor provisions cloud desktops with it preinstalled, or you install it on a machine you control. Once the service is running, the desktop appears in your workspace with a live preview, ready for jobs.
