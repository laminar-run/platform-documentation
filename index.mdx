...
1. **Connect a desktop.** Jobs run on a Windows machine with the [Minicor Desktop Service](/running/desktop-service) installed. Use a cloud desktop provisioned through Minicor or a machine in your own environment.
...
| **Deploy anywhere** | [Desktops, virtual machines, browsers, and Citrix](/running/desktops#where-automations-run). Host on our cloud, or [entirely on yours](/operations/network-boundary). |
